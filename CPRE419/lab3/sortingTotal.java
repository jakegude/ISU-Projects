...
public class sortingTotal {
	...
	public static void main(String[] args) throws Exception {
		...
		job_one.setJarByClass(sortingTotal.class);
		...
		job_two.setJarByClass(sortingTotal.class);
		...
		InputSampler.Sampler<IntWritable, Text> sampler = new InputSampler.RandomSampler<IntWritable, Text>(reduce_tasks, reduce_tasks, reduce_tasks);
